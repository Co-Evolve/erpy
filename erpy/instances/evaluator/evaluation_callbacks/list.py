...
from erpy.framework.environment import Environment, EnvironmentConfig
from erpy.framework.evaluator import EvaluationCallback, EvaluationResult, EvaluatorConfig
...
class EvaluationCallbackList(EvaluationCallback):
    def __init__(
            self,
            evaluation_callbacks: List[EvaluationCallback]
            ):
        super().__init__()
